...
class NotificationReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        runBlocking {
            ...
            createNotification(context , currentId.toString() , currentTodo!!.title , currentTodo.description , notificationManager)
        }
    }
    ...
    private fun createNotification(
        ...
        val notification = NotificationCompat.Builder(context!!, id)
            ...
            .setContentTitle(description).setPriority(NotificationCompat.PRIORITY_HIGH).build()
